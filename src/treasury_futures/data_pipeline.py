...
Extracted from 01_TreasuryFutures.ipynb so the notebook only orchestrates runs.
"""
...
from .paths import DB_PATH, INPUT_DIR
...
# Wind 品种代码、历史分钟 CSV，以及允许从 Wind 拉取分钟线的最早合约。
PRODUCT_WIND_CODE = "T.CFE"
HISTORICAL_MINUTE_CSV = INPUT_DIR / "T_mindf.csv"
